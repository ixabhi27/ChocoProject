...
function handle_addCartItem() {
  ...
  console.log(itemsAdded,'itemsAddedArray')
 // update();
 updateTotalOfCart(itemsAdded);
}
...
function handle_removeCartItem() {
  ...
  itemsAdded = itemsAdded.filter(
    (el) =>
      el.title != this.parentElement.querySelector(".cart-prod-title").innerHTML
  );
...
function updateTotalOfCart(arrayOfValues) {
...
//     let price = parseFloat(
//       priceElement.innerHTML.toString().replace("$ ", "")
//     );
...
function CartBoxComponent(title, price, imgSrc) {
  ...
  return `
    <div class="cart-box">
        <img src=${imgSrc} alt="" class="prod-img">
